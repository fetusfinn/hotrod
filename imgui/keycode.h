...
//
// wrapper for the GLFW mouse button codes
//
...
//
// wrapper for the GLFW keycodes, makes it a bit easier to write and can use it as a type
// todo : format
//
enum keycode_t : int
{
	...
	// printable keys, these are all just their ascii values (capital letters)
	...
	KEY_WORLD_1 = GLFW_KEY_WORLD_1,			// special non english keyboard key
