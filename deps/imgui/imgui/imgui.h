...
namespace ImGui
{
    ...
    IMGUI_API bool          MenuItem(const char* label, const char* shortcut, bool* p_selected, bool enabled = true, bool dont_close = false);   // return true when activated + toggle (*p_selected) if p_selected != NULL
